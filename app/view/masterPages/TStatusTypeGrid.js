Ext.define('GDPR.view.masterPages.TStatusTypeGrid' ,{
    extend: 'Ext.grid.Panel',
    alias : 'widget.view_masterpages_tstatustypegrid',
    ...
    initComponent: function() { 
        var me = this;
        me.gridURL = GDPR.gbl.constants.URL_MASTER_PANEL_TSTATUSTYPE;
    ...
    buildItems: function (me, gridURL, rEditor) {  
        var modelConfig = {
            "modelName" : 'TStatusType',
            "modelRoot" : 'tstatusType'
        }
        //Creating a dummy record for grids new entry
        var createRecordDummy = {ID: '0', levelDescription: ''}
        ...
        me.columns = [{
            ...
            header: 'Level Description', dataIndex: 'levelDescription', flex: 1,
            editor: {
